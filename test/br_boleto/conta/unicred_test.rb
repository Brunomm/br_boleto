...
describe BrBoleto::Conta::Unicred do
	...
	context "valores padrões" do
		it "deve setar a carteira com '09' " do
			subject.class.new.carteira.must_equal '09'
		end
	...
	describe "Validations" do
		...
		context 'Validações padrões da carteira' do
			subject { BrBoleto::Conta::Unicred.new }
	...
	it "#versao_layout_arquivo_cnab_240" do
		subject.versao_layout_arquivo_cnab_240.must_equal '082'
	end
	it "#versao_layout_lote_cnab_240" do
		subject.versao_layout_lote_cnab_240.must_equal '041'
	end
	...
	describe "#get_especie_titulo" do
		context "CÓDIGOS para o cnab 400 do Unicred" do
