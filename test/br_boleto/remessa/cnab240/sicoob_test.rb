...
describe BrBoleto::Remessa::Cnab240::Sicoob do
	subject { FactoryBot.build(:remessa_cnab240_sicoob, lotes: lote) }
	let(:pagamento) { FactoryBot.build(:remessa_pagamento, valor_documento: 100.00) }
	...
	describe "#complemento_trailer_lote" do
		let(:pagamento_2) { FactoryBot.build(:remessa_pagamento, valor_documento: 50.25) }
