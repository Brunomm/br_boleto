			...
			class Bradesco < BrBoleto::Remessa::Cnab240::Base
				...
				def informacoes_da_conta
					...
					if (conta.conta_corrente_dv.to_s).size == 2                            # Para os Bancos que se utilizam de duas posições para o Dígito Verificador do Número da Conta Corrente.
						...
						informacoes << "#{conta.conta_corrente_dv}".adjust_size_to(2, '0')  # Caso contrário ajustar o conta_corrente_dv para 2 digitos adicionando zero no final
					end
				...
				def complemento_p(pagamento)
					...
					if (conta.conta_corrente_dv.to_s).size == 2                             # Para os Bancos que se utilizam de duas posições para o Dígito Verificador do Número da Conta Corrente.
						...
						complemento << "#{conta.conta_corrente_dv}".adjust_size_to(2, '0')   # Caso contrário ajustar o conta_corrente_dv para 2 digitos adicionando zero no final
					end
