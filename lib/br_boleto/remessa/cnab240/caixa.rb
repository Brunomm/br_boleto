		...
		module Cnab240
			class Caixa < BrBoleto::Remessa::Cnab240::Base
				...
				########## VALIDAÇÕES ESPECÍFICAS DA DESTE OBJETO PARA A CONTA ##########
					def valid_versao_aplicativo_required; true end # <= Vero do aplicativo é obrigatória
				#########################################################################
				...
				def complemento_p(pagamento)
					...
					complemento << "#{conta.modalidade}".adjust_size_to(conta.valid_modalidade_length, '2', :right)
